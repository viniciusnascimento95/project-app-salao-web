  ...
  <div class="row">
    ...
    <div class="col-sm-2 col-md-3">
      <div class="form-group">
        ...
        <input type="datetime" name="data_hora_agendamento" class="form-control {{ $errors->has('data_hora_agendamento') ? 'is-invalid': '' }}" 
        value="{{$schedule->data_hora_agendamento_Formated()}}" title="Selecione o data e hora">
    ...
    <div class="col-sm-3 col-md-2">
      <div class="form-check">
        ...
        <input type="checkbox" class="form-check-input {{ $errors->has('servico_realizado') ? 'is-invalid': '' }}" value="{{ isset($schedule) && isset($schedule->servico_realizado) && empty (old('servico_realizado')) ? $schedule->servico_realizado : old('servico_realizado') }}" name="servico_realizado">
